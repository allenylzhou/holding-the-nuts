...
, NAME VARCHAR2(50 CHAR) NOT NULL 
, GS_ID NUMBER(20) NOT NULL 
, CONSTRAINT LOCATION_GAME_RELATIONSHI_PK PRIMARY KEY ( USER_ID , NAME , GS_ID ) ENABLE 
, CONSTRAINT LOCATION_GAME_RELATIONSHI_FK1 
	FOREIGN KEY ( GS_ID ) 
	REFERENCES GAME ( GS_ID )
	ON DELETE CASCADE ENABLE
, CONSTRAINT LOCATION_GAME_RELATIONSHI_FK2 
