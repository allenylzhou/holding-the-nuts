...
CREATE SEQUENCE BACKING_AGREEMENT_SEQUENCE INCREMENT BY 1 START WITH 0 MAXVALUE 20000 MINVALUE 0 NOCACHE;

INSERT INTO USERS (USER_ID, USERNAME,PASSWORD) VALUES (0,'AAA','A');
INSERT INTO USERS (USER_ID, USERNAME,PASSWORD) VALUES (1,'BBB','B');
INSERT INTO USERS (USER_ID, USERNAME,PASSWORD) VALUES (2,'CCC','C');
INSERT INTO USERS (USER_ID, USERNAME,PASSWORD) VALUES (3,'DDD','D');
INSERT INTO USERS (USER_ID, USERNAME,PASSWORD) VALUES (4,'EEE','E');
...
TO_DATE('04-10-2013 23:00:00', 'DD-MM-YYYY HH24:MI:SS'), 100, 0, 'A');
INSERT INTO GAME (GS_ID, USER_ID, START_DATE, END_DATE, AMOUNT_IN, AMOUNT_OUT, LOCATION_NAME) 
VALUES (6, 0, TO_DATE('04-10-2013 22:00:00', 'DD-MM-YYYY HH24:MI:SS'), 
TO_DATE('04-10-2013 23:59:59', 'DD-MM-YYYY HH24:MI:SS'), 100, 500, 'A');
